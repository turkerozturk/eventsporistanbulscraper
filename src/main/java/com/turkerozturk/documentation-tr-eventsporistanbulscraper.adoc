...
Aşağıdaki komut çalıştırıldığında uygulama çalışacak ve birkaç dakika içinde veritabanını internetteki verilerle doldurmuş olacak.
İşlemler yapılırken konsola çıktı verdiğinden, hangi koşu verisini aldığını görmek mümkün.
